...
public class SignupTest {
    ...
    private SignupDto invalidEmailSignupDto;
    private SignupDto invalidPasswordSignupDto;


    // 각 테스트 실행 전에 실행되어 필요한 초기 설정을 수행
    @BeforeEach
    public void setUp() {
         validSignupDto = new SignupDto("testUser1", "tnthtn35!", "test@example.com", new Date(), "male", 180, true);
         invalidEmailSignupDto = new SignupDto("testUser2", "tnthtn35!", "test@example.com", new Date(), "female", 180, false);
         invalidPasswordSignupDto = new SignupDto("testUser3", "tnthtn35", "test@example.com", new Date(), "male", 180, false);
    }
    ...
    public void testRegisterUserWithValidData() {
        ...
        assertDoesNotThrow(() -> signupService.registerUser(validSignupDto));
    ...
    public void testRegisterUserWithInvalidEmail() {
        ...
        CustomException exception = assertThrows(CustomException.class, () -> {
            signupService.registerUser(invalidEmailSignupDto);
        });
    ...
    public void testRegisterUserWithInvalidPassword() {
        ...
        assertThrows(CustomException.class, () -> {
            signupService.registerUser(invalidPasswordSignupDto);
        });
    }
