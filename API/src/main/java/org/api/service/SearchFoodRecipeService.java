...
import org.api.openapi.RecipeIdData;
...
public class SearchFoodRecipeService {
    ...
    public void getFoodRecipes(String foodName) {
        String jsonString = getRecipeIdByName(foodName);
        recipeIdExtractor(jsonString);
    }
    ...
    private int recipeIdExtractor(String jsonString) throws JsonProcessingException {
        int recipeId = 0;
